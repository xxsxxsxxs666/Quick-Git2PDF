...
class SwinTransformerSys3D(nn.Module):
    ...
    def __init__(self, pretrained=None,
        ...
        self.pretrained2d = pretrained2d # True
        self.num_classes = num_classes # 3
        self.num_layers = len(depths) # number of swin transformer block
        self.embed_dim = embed_dim # number of patch embedding size (default: 96)
...
if __name__ == '__main__':
    ...
    swin_unet = SwinTransformerSys3D(img_size=(128, 128, 128),
                                     patch_size=(4, 4, 4),
                                     in_chans=1,
                                     num_classes=2,
                                     )
