...
from data.loader import prepare_datalist, prepare_datalist_with_file, \
    prepare_image_list, save_json, write_data_reference, load_json, prepare_main_auxiliary_with_img_datalist_with_file
from transform.utils import get_transform, get_multi_phase_transform_with_image
...
if __name__ == "__main__":
    ...
    if cfg.dic['mode'] == 'train':
        ...
        train_transforms, val_transforms, save_transform = get_multi_phase_transform_with_image(cfg.dic['transform'])
        if cfg.dic["train"]["loader"].get("file_path"):
            files = [load_json(cfg.dic["train"]["loader"]["file_path"])]
        elif cfg.dic["train"]["loader"].get("val_set"):
            val_files = prepare_main_auxiliary_with_img_datalist_with_file(main_file=cfg.CS_M,
            ...
            train_files = prepare_main_auxiliary_with_img_datalist_with_file(main_file=cfg.CS_M,
                                                                             auxiliary_file=cfg.CS_A,
                                                                             main_img_file=cfg.I_M,
                                                                             auxiliary_img_file=cfg.I_A,
                                                                             label_file=cfg.train_label_path,
        ...
        if cfg.dic["test"]["loader"].get("file_path"):
            ...
            files = prepare_main_auxiliary_with_img_datalist_with_file(main_file=cfg.CS_M,
                                                                       auxiliary_file=cfg.CS_A,
                                                                       main_img_file=cfg.I_M,
                                                                       auxiliary_img_file=cfg.I_A,
        ...
        infer_transforms = get_multi_phase_transform_with_image(cfg.dic['transform'], mode='infer')
